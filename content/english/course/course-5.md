...
**Output Format:**    
    For each test case, print "True" or "False", separated by new 
line.
...
3. E Balagurusamy., Programming in ANSI C, 8th Edition, Tata McGRAW HILL, New
Delhi, 2019.
4. Byron Gottfried. , Programming with C , 4th Edition,Schaum's Outlines , Mc GRAW
HILL Edition, 2018.


### Online Resources
1. Solve C | HackerRank (https://www.hackerrank.com/domains/c?badge_type=c)

2. Courses (neetcode.io) (https://neetcode.io/courses) 
3. C Tutorial - Learn C Programming Language (geeksforgeeks.org)
(https://www.geeksforgeeks.org/c-programming-language/?ref=shm) 
4. Problem Solving Through Programming In C - Course (nptel.ac.in)
